...
**
    ...
    *   **Schedule Jobs:** Now, we'll set up automated tasks for SnapRAID.
        *   In the main OMV menu, go to **System > Scheduled Jobs**.
                        *   Click the `Add` button to create a new scheduled task.                > **<img width="743" height="382" alt="image" src="https://github.com/user-attachments/assets/bc3a3d3d-9f0f-4710-a55f-537795f480df" />
**
...
**
                                > *Caption: Configuration for the weekly snapraid scrub task.*                *   After adding both tasks, click the `Apply` button in the top bar if prompted, to save the changes.
